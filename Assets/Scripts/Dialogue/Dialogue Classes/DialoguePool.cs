...
public class DialoguePool : DialogueClip
{
    ...
    public void LoadDialoguePool(DialoguePool dp)
    {
        ...
        response_3_Amiability = 
            response_3_NextClip.DialoguePoolResponse_Respect;
