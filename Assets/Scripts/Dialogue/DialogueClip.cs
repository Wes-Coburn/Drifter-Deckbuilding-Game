...
public class DialogueClip : ScriptableObject
{
    ...
    [SerializeField] [Range(-5, 5)] private int dialoguePoolResponse_Amiability;
    public int DialoguePoolResponse_Amiability { get => dialoguePoolResponse_Amiability; }
    ...
    [SerializeField] [Range(-5, 5)] protected int response_1_Amiability;
    public int Response_1_Amiability { get => response_1_Amiability; }
    ...
    { get => response_2; }
    [SerializeField] [Range(-5, 5)] protected int response_2_Amiability;
    public int Response_2_Amiability { get => response_2_Amiability; }
