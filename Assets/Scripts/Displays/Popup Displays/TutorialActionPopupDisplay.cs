...
public class TutorialActionPopupDisplay : MonoBehaviour
{
    ...
    private void SetCurrentTip()
    {
        ...
        switch (currentTip)
        {
            ...
            case 2:
                text = "This is the enemy hero.";
                position.Set(-270, 230);
                break;

            case 3:
                text = "Your hero has a <color=\"red\"><b>Health</b></color> value, " +
                    "an <color=\"green\"><b>Energy</b></color> value, and a <color=\"purple\"><b>Hero Power</b></color>. " +
                    "Hover over each component for an explanation.";
                position.Set(470, 0);
                break;

            case 4:
                text = "Damage dealt to your hero reduces their <color=\"red\"><b>Health</b></color>. If your hero's health drops to 0, you lose.";
                position.Set(470, 0);
                break;
            ...
            case 6:
                text = "You can use your <color=\"purple\"><b>Hero Power</b></color> once each turn. " +
                    "Each time you use your hero power 3+ times, you can use your <color=\"purple\"><b>Hero Ultimate</b></color> once.";
                position.Set(470, 0);
                break;

            case 7:
                text = "You draw cards from your <b>deck</b>. When it runs out of cards, you'll shuffle your discard pile back into it.";
            ...
            case 9:
                text = "After you draw your first hand, you can replace any number of cards with new ones from your deck. This is known as a <b>Mulligan</b>.";
                position.Set(-570, -190);
                break;
